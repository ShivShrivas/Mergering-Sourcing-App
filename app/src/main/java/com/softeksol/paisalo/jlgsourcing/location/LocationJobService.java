...
import static com.softeksol.paisalo.jlgsourcing.activities.ActivityOperationSelect.JOB_STATE_CHANGED;
import static com.softeksol.paisalo.jlgsourcing.activities.ActivityOperationSelect.LOCATION_ACQUIRED;
...
//                            startService(i1); //i have disabled the call as the server URL in intent service is dummy URL. Change the URL to your server URL and call this intent service
                        ...
                        Log.e("LOCATION2",location.getLatitude()+" / "+location.getLongitude());// add location points to the list
                    }
                }
            }
    ...
    private void createNotification() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            notification = mBuilder.setSmallIcon(android.R.drawable.ic_menu_mylocation).setTicker("Tracking").setWhen(0)
                    .setAutoCancel(false)
            ...
            notification = mBuilder.setSmallIcon((Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)? android.R.drawable.ic_menu_mylocation:R.mipmap.ic_launcher).setTicker("Tracking").setWhen(0)
                    .setAutoCancel(false)
                    .setCategory(Notification.EXTRA_BIG_TEXT)
                    .setContentTitle("Tracking")
